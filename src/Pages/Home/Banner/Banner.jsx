                ...
                <div className='absolute md:top-56 lg:top-32 top-52 right-8 lg:left-0'>
                    <div className='flex md:flex-row flex-col-reverse lg:justify-evenly items-center'>
                        <div>
                           ...
                           <Link to={'/allToy'}> <button className='btn bg-pink-500 border-0 px-14 text-md md:text-xl font-bold mt-4  md:mt-10 ms-28 md:ms-8  lg:ms-0 rancho'>Go to Shop</button></Link>
                        </div>
